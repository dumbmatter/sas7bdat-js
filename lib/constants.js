...
const TIME_FORMAT_STRINGS = ['TIME'];
const DATE_TIME_FORMAT_STRINGS = ['DATETIME'];
const DATE_FORMAT_STRINGS = ['YYMMDD', 'MMDDYY', 'DDMMYY', 'DATE', 'JULIAN', 'MONYY'];

// Timestamps are 01/01/1960 offset by some seconds
